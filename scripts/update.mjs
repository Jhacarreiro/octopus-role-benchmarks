...
const cyberbenchDataset=await fetchCyberBench({url:cyberbenchConfig.sourceUrl});
const cyberbenchResolved=resolveCyberBenchBySlug(slugs,cyberbenchConfig.slugToLabel,cyberbenchDataset);
